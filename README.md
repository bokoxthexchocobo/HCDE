...
- **C# migration:** incremental server-first rewrite under [`csharp/`](csharp/) — Phase 1 tools/protocol complete, Phase 2 net transport and live wire codecs in progress (190 xUnit tests, CI enabled).
