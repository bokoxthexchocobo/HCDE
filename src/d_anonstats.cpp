...
void D_ConfirmSendStats()
{
	...
	// TODO: texts
	static const char *const MESSAGE_TEXT = "In order to decide where to focus development, the HCDE team would like to know a little bit about the hardware it is run on.\n" \
		...
		"It will merely be used for decision-making about HCDE's future development.\n" \
	...
	static const char *const TITLE_TEXT = "HCDE needs your help!";
