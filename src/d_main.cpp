...
CUSTOM_CVAR(Int, compatmode, 0, CVAR_ARCHIVE|CVAR_NOINITCALL)
{
	...
	case 9: // Stricter MBF21 compatibility
		...
		w = COMPATF2_POINTONLINE | COMPATF2_EXPLODE1 | COMPATF2_EXPLODE2 | COMPATF2_AVOID_HAZARDS |
			COMPATF2_STAYONLIFT | COMPATF2_EMULATEMIKOPORTALS | COMPATF2_RESERVEDLINEFLAG;
		break;
	}
	compatflags = v;
	compatflags2 = w;
...
static int D_DoomMain_Internal (void)
{
	...
	if (logfile.IsNotEmpty())
	{
		...
		DebugTrace::Markf("startup", "logfile %s", logfile.GetChars());
	}
	...
	DebugTrace::Mark("startup", "startup logging configured");
	...
	DebugTrace::Mark("startup", "iwad manager initialized");
	...
	do
	{
		...
		*/
		...
		D_Cleanup();
		DebugTrace::Mark("startup", "cleanup complete");
