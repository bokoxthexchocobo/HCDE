...
#define VERSIONSTR "0.4.11"

// The version as seen in the Windows resource
#define RC_FILEVERSION 0,4,11,0
#define RC_PRODUCTVERSION 0,4,11,0
...
// This should always refer to the HCDE version a derived port is based on and not reflect the derived port's version number!
#define ENG_MAJOR 5
#define ENG_MINOR 0
...
#define GAMENAME "HCDE"
#define WGAMENAME L"HCDE"
