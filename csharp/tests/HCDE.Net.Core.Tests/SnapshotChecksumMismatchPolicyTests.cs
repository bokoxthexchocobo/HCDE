...
public class SnapshotChecksumMismatchPolicyTests
{
    ...
    [Fact]
    public void ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp_RequiresFourMismatchBucketsWithAllTailsApplied()
    {
        var result = new SnapshotChecksumApplyResult(
            compared: true,
            mismatchCount: 4,
        ...
        Assert.True(SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp(
            result,
            appliedInvasionAuthorityEvents: true,
            appliedInvasionActorDeltas: true,
            appliedInvasionPresentationEcho: true,
            appliedInvasionCoopDeadSpawns: true,
            SnapshotChecksumMismatchPolicyKind.ResyncNetStateOnMismatch));
        Assert.False(SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp(
            new SnapshotChecksumApplyResult(
                compared: true,
                mismatchCount: 3,
                localBucketMissing: false,
    ...
    [Fact]
    public void ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp_RequiresFourMismatchBucketsWithAllTailsApplied()
    {
        var result = new SnapshotChecksumApplyResult(
            compared: true,
            mismatchCount: 4,
        ...
        Assert.True(SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp(
            result,
            appliedCoopAuthorityEvents: true,
            appliedCoopActorDeltas: true,
            appliedCoopPresentationEcho: true,
            appliedCoopDeadSpawns: true,
            SnapshotChecksumMismatchPolicyKind.ResyncNetStateOnMismatch));
        Assert.False(SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp(
            new SnapshotChecksumApplyResult(
                compared: true,
                mismatchCount: 3,
                localBucketMissing: false,
    ...
    [Fact]
    public void ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUpFollowUp_RequiresFiveMismatchBucketsWithAllTailsApplied()
    {
        var result = new SnapshotChecksumApplyResult(
            compared: true,
            mismatchCount: 5,
        ...
        Assert.True(SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUpFollowUp(
            result,
            appliedCoopAuthorityEvents: true,
            appliedCoopActorDeltas: true,
            appliedCoopPresentationEcho: true,
            appliedCoopDeadSpawns: true,
            SnapshotChecksumMismatchPolicyKind.ResyncNetStateOnMismatch));
        Assert.False(SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUpFollowUp(
            new SnapshotChecksumApplyResult(
                compared: true,
                mismatchCount: 4,
                localBucketMissing: false,
