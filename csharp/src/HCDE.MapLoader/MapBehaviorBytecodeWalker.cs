...
public static class MapBehaviorBytecodeWalker
{
    ...
    private static int GetWordOperandSkipCount(int opcode) => opcode switch
    {
        ...
        (int)AcsPcode.SetMarineSprite
            ...
            or (int)AcsPcode.GetLineRowOffset or (int)AcsPcode.ActivatorTid
            or (int)AcsPcode.GetSectorFloorZ or (int)AcsPcode.GetSectorCeilingZ
            or (int)AcsPcode.GetSigilPieces or (int)AcsPcode.GetLevelInfo
        ...
        (int)AcsPcode.AndScriptVar or (int)AcsPcode.AndMapVar or (int)AcsPcode.AndWorldVar
            or (int)AcsPcode.AndGlobalVar or (int)AcsPcode.AndMapArray or (int)AcsPcode.AndWorldArray
            or (int)AcsPcode.AndGlobalArray or (int)AcsPcode.EorScriptVar or (int)AcsPcode.EorMapVar
