...
public sealed class GuestWorldStateStore : IWorldDeltaApplySink, IActorDeltaApplySink, ICoopDeadSpawnsApplySink
{
    ...
    public void CommitAppliedAuthorityEvents(ReadOnlySpan<AuthorityEventRecord> records)
    {
        ...
        _presentationEchoRollingHash = SnapshotChecksumAuthorityEventPolicy.PolishPresentationEchoRollingHash(
        ...
        _presentationEchoRollingHash = SnapshotChecksumActorDeltaPolicy.PolishPresentationEchoRollingHash(
            _presentationEchoRollingHash,
            _actorDeltaRollingHash);
        _lineSpecRollingHash = SnapshotChecksumLineSpecPolicy.PolishRollingHashWithActorDelta(
            _lineSpecRollingHash,
            _actorDeltaRollingHash);
    ...
    public void CommitAppliedActorDeltas(IReadOnlyList<ActorDeltaRecord> records)
    {
        ...
        _presentationEchoRollingHash = SnapshotChecksumActorDeltaPolicy.PolishPresentationEchoRollingHash(
            _presentationEchoRollingHash,
            _actorDeltaRollingHash);
        _presentationEchoRollingHash = SnapshotChecksumPresentationEchoPolicy.PolishRollingHashWithAuthorityEvent(
            _presentationEchoRollingHash,
            _authorityEventRollingHash);
        _presentationEchoRollingHash = SnapshotChecksumPresentationEchoPolicy.PolishRollingHash(
            _presentationEchoRollingHash,
        ...
        _lineSpecRollingHash = SnapshotChecksumLineSpecPolicy.PolishRollingHashWithActorDelta(
            _lineSpecRollingHash,
            _actorDeltaRollingHash);
        _lineSpecRollingHash = SnapshotChecksumActorDeltaPolicy.PolishLineSpecRollingHash(
            _lineSpecRollingHash,
            _actorDeltaRollingHash);
        _lineSpecRollingHash = SnapshotChecksumLineSpecPolicy.PolishRollingHashWithAuthorityEvent(
            _lineSpecRollingHash,
        ...
        _actorDeltaRollingHash = SnapshotChecksumPresentationEchoPolicy.PolishActorDeltaRollingHash(
            _actorDeltaRollingHash,
            _presentationEchoRollingHash);
        _lineSpecRollingHash = SnapshotChecksumPresentationEchoPolicy.PolishLineSpecRollingHash(
            _lineSpecRollingHash,
            _presentationEchoRollingHash);
        _presentationEchoRollingHash = SnapshotChecksumLineSpecPolicy.PolishPresentationEchoRollingHash(
            _presentationEchoRollingHash,
            _lineSpecRollingHash);
        _authorityEventRollingHash = SnapshotChecksumPresentationEchoPolicy.PolishAuthorityEventRollingHash(
            _authorityEventRollingHash,
            _presentationEchoRollingHash);
        _actorDeltaRollingHash = SnapshotChecksumActorDeltaPolicy.PolishActorDeltaRollingHash(
            _actorDeltaRollingHash,
            _authorityEventRollingHash);
        _lineSpecRollingHash = SnapshotChecksumActorDeltaPolicy.PolishLineSpecRollingHash(
            _lineSpecRollingHash,
