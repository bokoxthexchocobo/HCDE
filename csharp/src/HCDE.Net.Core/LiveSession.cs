...
public sealed class LiveGuestSession
{
        ...
        IReadOnlyList<ServerSnapshotPlayerRecord> players)
    {
        ...
        var appliedCoopDeadSpawns = false;
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionLineSpecActorMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopLineSpecActorMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionActorDeltaMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionActorDeltaLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionActorDeltaPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopActorDeltaMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopActorDeltaLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopActorDeltaPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaCoopDeadSpawnMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaCoopDeadSpawnMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUp(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUp(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopAuthorityEventActorDeltaPresentationEchoCoopDeadSpawnActorLineSpecMultiBucketMismatchFollowUpFollowUpFollowUp(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionPresentationEchoMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnInvasionPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
        ...
        if (_lastChecksumApplyState.Compared
            && SnapshotChecksumMismatchPolicy.ShouldTriggerNetGapResyncOnCoopPresentationEchoLineSpecMismatch(
                new SnapshotChecksumApplyResult(
                    _lastChecksumApplyState.Compared,
                    _lastChecksumApplyState.MismatchCount,
                    _lastChecksumApplyState.LocalBucketMissing,
