...
**Verification:** `dotnet build` and `dotnet test` in `csharp/` — **315 tests passing** (CI: `.github/workflows/csharp.yml`; optional soak: `.github/workflows/csharp-cross-language-soak.yml`)  
