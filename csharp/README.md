...
Managed wire compatibility is gated by `dotnet test` (183 tests). Cross-language checks live under `validation/`:
...
csharp/
  ...
  tests/
    HCDE.*.Tests/        xUnit regression tests (183 passing)
```
